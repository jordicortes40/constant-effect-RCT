...
##-- Store the data
df <- as.data.frame(M)
write.table(x = df,file='../results_tables/SA_II_simulated_data_wide_window.txt',
...
##-- Store the data
df <- as.data.frame(M)
write.table(x = df,file='../results_tables/SA_II_simulated_data_narrow_window.txt',
            row.names = FALSE,col.names = TRUE,sep='\t')
