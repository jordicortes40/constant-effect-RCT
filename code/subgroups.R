...
##-- Between arms
png('../results_figures/MA_subgroup_analysis_BA.png',width=960,height = 670,res=144)
...
##-- Over-time
png('../results_figures/MA_subgroup_analysis_OT.png',width=960,height = 670,res=144)
...
png('../results_figures/MA_subgroup_analysis_BA_OT.png',width=960,height = 670,res=144)
